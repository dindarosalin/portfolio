    ...
    return (
        <section id="contact" className="h-screen pt-20">
            ...
            <div className='mt-7 flex justify-center flex-col gap-3 md:flex-row lg:flex-row md:gap-7 lg:gap-7'>
                <a href='docs/RESUME_DINDA_ROSALIN_HUSNA_2024.pdf' download="RESUME_DINDA_ROSALIN_HUSNA_2024.pdf" className="hover:shadow-md hover:shadow-gold hover:scale-105 transition cursor-pointer duration-500 ease-in-out shadow-sm shadow-gold outline-offset-2 rounded-full py-2 px-3 mt-4 text-gold">
                    <FontAwesomeIcon icon={faDownload} className='h-4' /> Get My Curriculum Vitae
                </a>
                <a href="https://wa.me/+6282333525346" className="hover:shadow-md hover:shadow-gold hover:scale-105 transition cursor-pointer duration-500 ease-in-out shadow-sm shadow-gold outline-offset-2 rounded-full py-2 px-3 mt-4 text-gold">
