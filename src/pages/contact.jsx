    ...
    return (
        <section id="contact" className="mt-9">
            ...
            <div className='mt-7 flex justify-center flex-col gap-3 md:flex-row lg:flex-row md:gap-7 lg:gap-7'>
                <a href='/resume.pdf' download="resume.pdf" className="hover:shadow-lg hover:shadow-gold hover:scale-105 transition cursor-pointer duration-500 ease-in-out shadow-md shadow-gold outline outline-gold outline-1 outline-offset-2 rounded py-2 px-3 mt-4 text-gold">
